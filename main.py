...
class Features(BaseModel):
    ...
    neighbourhood_group: str = Field(..., min_length=1, description="Borough or neighborhood group")
    neighbourhood: str = Field(..., min_length=1, description="Specific neighborhood")
